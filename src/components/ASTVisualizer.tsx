...
function TreeNode({
  ...
  return (
    <div className="select-none">
      <div
        className="group flex items-center hover:bg-gray-50 dark:hover:bg-gray-700 py-0.5 transition-colors duration-150"
...
function ASTVisualizer({ text, collapseAll = false }: ASTVisualizerProps) {
  ...
  return (
    <div className="h-full flex flex-col">
      <div className="flex-1 overflow-auto bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-lg p-2 text-sm">
        {error ? (
