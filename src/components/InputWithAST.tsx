      ...
      <div className="flex-1 min-w-0 flex flex-col overflow-hidden">
        <div className="flex-1 overflow-auto bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-lg p-2 text-sm relative">
          {error ? (
            ...
            <>
              {/* Clear button and multi-select info - absolutely positioned */}
              {hasSelection && (
                <div className="absolute top-2 right-2 z-10 flex items-center gap-2">
                  <span className="px-2 py-0.5 text-xs bg-gray-700 text-white rounded">
                    {selectedPositions.length} selected
                  </span>
                  <button
                    onClick={handleClearSelection}
                    type="button"
                    title="Clear all selections and return to edit mode"
              ...
              {!hasSelection && (
                <div className="absolute top-2 right-2 z-10 text-xs text-gray-500 dark:text-gray-400">
